...
def main():
    os.chdir('/Users/wimbime1/Desktop/Python/Miguel_SelfDriving_Car/DeepPiCar/models/object_detection')
    direct = '/Users/wimbime1/Desktop/Python/Miguel_SelfDriving_Car/DeepPiCar'
